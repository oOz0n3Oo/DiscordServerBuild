# SentinelForge Discord Companion Bot

Automated Discord server builder & manager for SentinelForge CTF platform.
...
1. **Extract the zip**
```bash
unzip sentinelforge-companion.zip
cd sentinelforge-companion
```
...
- Set SentinelForge API URL & token (in Config tab)
...
{
  "api": {
    "url": "http://sentinelforge:3000/api/v1",
